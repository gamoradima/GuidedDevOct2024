namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcRealtyAveragePriceMethodsWrapper

	/// <exclude/>
	public class UsrCalcRealtyAveragePriceMethodsWrapper : ProcessModel
	{

		public UsrCalcRealtyAveragePriceMethodsWrapper(Process process)
			: base(process) {
